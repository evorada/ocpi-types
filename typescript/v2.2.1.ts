// To parse this data:
//
//   import { Convert, V221 } from "./file";
//
//   const v221 = Convert.toV221(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface V221 {
...
export class Convert {
    public static toV221(json: string): V221 {
        return cast(JSON.parse(json), r("V221"));
    }

    public static v221ToJson(value: V221): string {
        return JSON.stringify(uncast(value, r("V221")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Tariff": o([
        ...
        { json: "id", js: "id", typ: "" },
        { json: "last_updated", js: "last_updated", typ: "" },
        { json: "max_price", js: "max_price", typ: u(undefined, u(r("Price"), null)) },
        { json: "min_price", js: "min_price", typ: u(undefined, u(r("Price"), null)) },
        { json: "party_id", js: "party_id", typ: "" },
        { json: "start_date_time", js: "start_date_time", typ: u(undefined, u(null, "")) },
    ...
    "Price": o([
        { json: "excl_vat", js: "excl_vat", typ: 3.14 },
        { json: "incl_vat", js: "incl_vat", typ: u(undefined, u(3.14, null)) },
    ], false),
