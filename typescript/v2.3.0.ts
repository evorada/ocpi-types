// To parse this data:
//
//   import { Convert, V230 } from "./file";
//
//   const v230 = Convert.toV230(json);
//
...
export class Convert {
    public static toV230(json: string): V230 {
        return cast(JSON.parse(json), r("V230"));
    }

    public static v230ToJson(value: V230): string {
        return JSON.stringify(uncast(value, r("V230")), null, 2);
    }
}
