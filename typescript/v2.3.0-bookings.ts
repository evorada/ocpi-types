// To parse this data:
//
//   import { Convert, V230Bookings } from "./file";
//
//   const v230Bookings = Convert.toV230Bookings(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface V230Bookings {
...
export interface Booking {
    ...
    bookable_parking_option?: BookableParkingOptions | null;
    booking_requests:         BookingRequestStatus[];
    booking_terms:            BookingTerms;
    booking_tokens?:          BookingToken[] | null;
    canceled?:                Cancellation | null;
...
export interface BookableParkingOptions {
...
export interface Timeslot {
    end_before:            string;
    green_energy_support?: boolean | null;
...
export interface BookingTerms {
    booking_terms?:                null | string;
    cancel_until_minutes:          number;
    change_not_allowed?:           boolean | null;
    change_until_minutes:          number;
    early_start_allowed?:          boolean | null;
    early_start_time?:             number | null;
    late_stop_allowed?:            boolean | null;
    late_stop_time?:               number | null;
    noshow_fee?:                   boolean | null;
    noshow_timeout?:               number | null;
    overlapping_bookings_allowed?: boolean | null;
    remote_auth_supported?:        boolean | null;
    RFID_auth_required?:           boolean | null;
    supported_access_methods:      LocationAccess[];
    token_groups_supported?:       boolean | null;
}
...
export interface BookingLocation {
    ...
    bookable_parking_options?: BookableParkingOptions[] | null;
...
export enum ReservationRestrictionType {
    ...
    ReservationCancellationFees = "RESERVATION_CANCELLATION_FEES",
    ReservationExpires = "RESERVATION_EXPIRES",
    ReservationOvertime = "RESERVATION_OVERTIME",
}
...
export class Convert {
    public static toV230Bookings(json: string): V230Bookings {
        return cast(JSON.parse(json), r("V230Bookings"));
    }

    public static v230BookingsToJson(value: V230Bookings): string {
        return JSON.stringify(uncast(value, r("V230Bookings")), null, 2);
    }
}
...
const typeMap: any = {
    "V230Bookings": o([
        ...
        { json: "booking", js: "booking", typ: u(undefined, r("Booking")) },
        { json: "booking_location", js: "booking_location", typ: u(undefined, r("BookingLocation")) },
        { json: "booking_request", js: "booking_request", typ: u(undefined, r("BookingRequest")) },
    ...
    "Booking": o([
        { json: "access_methods", js: "access_methods", typ: u(undefined, u(a(r("AccessMethod")), null)) },
        { json: "authorization_reference", js: "authorization_reference", typ: "" },
        { json: "bookable_parking_option", js: "bookable_parking_option", typ: u(undefined, u(r("BookableParkingOptions"), null)) },
        { json: "booking_requests", js: "booking_requests", typ: a(r("BookingRequestStatus")) },
        { json: "booking_terms", js: "booking_terms", typ: r("BookingTerms") },
        { json: "booking_tokens", js: "booking_tokens", typ: u(undefined, u(a(r("BookingToken")), null)) },
        { json: "canceled", js: "canceled", typ: u(undefined, u(r("Cancellation"), null)) },
        ...
        { json: "last_updated", js: "last_updated", typ: "" },
        { json: "location_id", js: "location_id", typ: "" },
        { json: "parking_id", js: "parking_id", typ: u(undefined, u(null, "")) },
        { json: "party_id", js: "party_id", typ: "" },
        { json: "period", js: "period", typ: r("Timeslot") },
        { json: "request_id", js: "request_id", typ: "" },
        { json: "reservation_status", js: "reservation_status", typ: r("ReservationStatus") },
        { json: "tariff_id", js: "tariff_id", typ: u(undefined, u(a(""), null)) },
    ], false),
    "AccessMethod": o([
        { json: "location_access", js: "location_access", typ: r("LocationAccess") },
        { json: "value", js: "value", typ: u(undefined, u(null, "")) },
    ], false),
    "BookableParkingOptions": o([
    ...
    "BookingRequestStatus": o([
        { json: "booking_request", js: "booking_request", typ: r("BookingRequest") },
        { json: "request_received", js: "request_received", typ: "" },
        { json: "request_status", js: "request_status", typ: r("ReservationRequestStatus") },
    ], false),
    "BookingRequest": o([
        { json: "authorization_reference", js: "authorization_reference", typ: "" },
        { json: "bookable_parking_option", js: "bookable_parking_option", typ: u(undefined, u(r("BookableParkingOptions"), null)) },
        ...
        { json: "party_id", js: "party_id", typ: "" },
        { json: "period", js: "period", typ: r("Timeslot") },
        { json: "power_required", js: "power_required", typ: u(undefined, u(0, null)) },
        { json: "request_id", js: "request_id", typ: "" },
        { json: "tokens", js: "tokens", typ: u(undefined, u(a(r("BookingToken")), null)) },
    ], false),
    "Cancellation": o([
        { json: "cancellation_reason", js: "cancellation_reason", typ: r("CanceledReason") },
        { json: "who_canceled", js: "who_canceled", typ: r("Role") },
    ], false),
    "Timeslot": o([
        { json: "end_before", js: "end_before", typ: "" },
        { json: "green_energy_support", js: "green_energy_support", typ: u(undefined, u(true, null)) },
        { json: "max_power", js: "max_power", typ: u(undefined, u(3.14, null)) },
        { json: "min_power", js: "min_power", typ: u(undefined, u(3.14, null)) },
        { json: "start_from", js: "start_from", typ: "" },
    ], false),
    "BookingToken": o([
        { json: "contract_id", js: "contract_id", typ: "" },
        { json: "country_code", js: "country_code", typ: "" },
    ...
    "BookingTerms": o([
        { json: "booking_terms", js: "booking_terms", typ: u(undefined, u(null, "")) },
        { json: "cancel_until_minutes", js: "cancel_until_minutes", typ: 3.14 },
        { json: "change_not_allowed", js: "change_not_allowed", typ: u(undefined, u(true, null)) },
        { json: "change_until_minutes", js: "change_until_minutes", typ: 3.14 },
        { json: "early_start_allowed", js: "early_start_allowed", typ: u(undefined, u(true, null)) },
        { json: "early_start_time", js: "early_start_time", typ: u(undefined, u(3.14, null)) },
        { json: "late_stop_allowed", js: "late_stop_allowed", typ: u(undefined, u(true, null)) },
        { json: "late_stop_time", js: "late_stop_time", typ: u(undefined, u(3.14, null)) },
        { json: "noshow_fee", js: "noshow_fee", typ: u(undefined, u(true, null)) },
        { json: "noshow_timeout", js: "noshow_timeout", typ: u(undefined, u(3.14, null)) },
        { json: "overlapping_bookings_allowed", js: "overlapping_bookings_allowed", typ: u(undefined, u(true, null)) },
        { json: "remote_auth_supported", js: "remote_auth_supported", typ: u(undefined, u(true, null)) },
        { json: "RFID_auth_required", js: "RFID_auth_required", typ: u(undefined, u(true, null)) },
        { json: "supported_access_methods", js: "supported_access_methods", typ: a(r("LocationAccess")) },
        { json: "token_groups_supported", js: "token_groups_supported", typ: u(undefined, u(true, null)) },
    ], false),
    "BookingLocation": o([
        { json: "bookable", js: "bookable", typ: u(undefined, u(r("Bookable"), null)) },
        { json: "bookable_parking_options", js: "bookable_parking_options", typ: u(undefined, u(a(r("BookableParkingOptions")), null)) },
        { json: "booking_terms", js: "booking_terms", typ: u(undefined, u(a(r("BookingTerms")), null)) },
        { json: "calendars", js: "calendars", typ: u(undefined, u(a(r("Calendar")), null)) },
        { json: "connector_id", js: "connector_id", typ: u(undefined, u(null, "")) },
        { json: "country_code", js: "country_code", typ: "" },
        { json: "evse_uid", js: "evse_uid", typ: u(undefined, u(null, "")) },
        { json: "id", js: "id", typ: "" },
    ...
    "Bookable": o([
        { json: "ad_hoc", js: "ad_hoc", typ: u(undefined, u(3.14, null)) },
        { json: "reservation_required", js: "reservation_required", typ: true },
    ], false),
    "Calendar": o([
        { json: "available_timeslots", js: "available_timeslots", typ: a(r("Timeslot")) },
        { json: "begin_from", js: "begin_from", typ: "" },
        { json: "end_before", js: "end_before", typ: "" },
        { json: "id", js: "id", typ: "" },
        { json: "last_updated", js: "last_updated", typ: "" },
        { json: "step_size", js: "step_size", typ: u(undefined, u(0, null)) },
    ], false),
    "CancelReservation": o([
    ...
    "Cdr": o([
        ...
        { json: "authorization_reference", js: "authorization_reference", typ: u(undefined, u(null, "")) },
        { json: "booking_id", js: "booking_id", typ: u(undefined, u(null, "")) },
