...
class AccessMethod:
    ...
    def __init__(self, location_access: LocationAccess, value: Optional[str]) -> None:
    ...
    def from_dict(obj: Any) -> 'AccessMethod':
        assert isinstance(obj, dict)
        location_access = LocationAccess(obj.get("location_access"))
        value = from_union([from_none, from_str], obj.get("value"))
        return AccessMethod(location_access, value)

    def to_dict(self) -> dict:
        result: dict = {}
        result["location_access"] = to_enum(LocationAccess, self.location_access)
        if self.value is not None:
            result["value"] = from_union([from_none, from_str], self.value)
        return result


class EvsePosition(Enum):
    CENTER = "CENTER"
    LEFT = "LEFT"
    RIGHT = "RIGHT"
...
class BookableParkingOptions:
    ...
    def __init__(self, dangerous_goods_allowed: Optional[bool], drive_through: Optional[bool], evse_position: Optional[EvsePosition], format: ConnectorFormat, max_vehicle_height: Optional[float], max_vehicle_length: Optional[float], max_vehicle_weight: Optional[float], max_vehicle_width: Optional[float], parking_space_length: Optional[float], parking_space_width: Optional[float], refrigeration_outlet: Optional[bool], restricted_to_type: bool, vehicle_types: List[VehicleType]) -> None:
        self.dangerous_goods_allowed = dangerous_goods_allowed
        self.drive_through = drive_through
        self.evse_position = evse_position
        self.format = format
        self.max_vehicle_height = max_vehicle_height
        ...
        self.refrigeration_outlet = refrigeration_outlet
    ...
    def from_dict(obj: Any) -> 'BookableParkingOptions':
        assert isinstance(obj, dict)
        dangerous_goods_allowed = from_union([from_none, from_bool], obj.get("dangerous_goods_allowed"))
        drive_through = from_union([from_none, from_bool], obj.get("drive_through"))
        evse_position = from_union([from_none, EvsePosition], obj.get("evse_position"))
        format = ConnectorFormat(obj.get("format"))
        max_vehicle_height = from_union([from_none, from_float], obj.get("max_vehicle_height"))
        max_vehicle_length = from_union([from_none, from_float], obj.get("max_vehicle_length"))
        max_vehicle_weight = from_union([from_none, from_float], obj.get("max_vehicle_weight"))
        max_vehicle_width = from_union([from_none, from_float], obj.get("max_vehicle_width"))
        parking_space_length = from_union([from_none, from_float], obj.get("parking_space_length"))
        parking_space_width = from_union([from_none, from_float], obj.get("parking_space_width"))
        refrigeration_outlet = from_union([from_none, from_bool], obj.get("refrigeration_outlet"))
        restricted_to_type = from_bool(obj.get("restricted_to_type"))
        vehicle_types = from_list(VehicleType, obj.get("vehicle_types"))
        return BookableParkingOptions(dangerous_goods_allowed, drive_through, evse_position, format, max_vehicle_height, max_vehicle_length, max_vehicle_weight, max_vehicle_width, parking_space_length, parking_space_width, refrigeration_outlet, restricted_to_type, vehicle_types)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.dangerous_goods_allowed is not None:
            result["dangerous_goods_allowed"] = from_union([from_none, from_bool], self.dangerous_goods_allowed)
        if self.drive_through is not None:
            result["drive_through"] = from_union([from_none, from_bool], self.drive_through)
        if self.evse_position is not None:
            result["evse_position"] = from_union([from_none, lambda x: to_enum(EvsePosition, x)], self.evse_position)
        result["format"] = to_enum(ConnectorFormat, self.format)
        if self.max_vehicle_height is not None:
            result["max_vehicle_height"] = from_union([from_none, to_float], self.max_vehicle_height)
        if self.max_vehicle_length is not None:
            result["max_vehicle_length"] = from_union([from_none, to_float], self.max_vehicle_length)
        if self.max_vehicle_weight is not None:
            result["max_vehicle_weight"] = from_union([from_none, to_float], self.max_vehicle_weight)
        if self.max_vehicle_width is not None:
            result["max_vehicle_width"] = from_union([from_none, to_float], self.max_vehicle_width)
        if self.parking_space_length is not None:
            result["parking_space_length"] = from_union([from_none, to_float], self.parking_space_length)
        if self.parking_space_width is not None:
            result["parking_space_width"] = from_union([from_none, to_float], self.parking_space_width)
        if self.refrigeration_outlet is not None:
            result["refrigeration_outlet"] = from_union([from_none, from_bool], self.refrigeration_outlet)
        result["restricted_to_type"] = from_bool(self.restricted_to_type)
        result["vehicle_types"] = from_list(lambda x: to_enum(VehicleType, x), self.vehicle_types)
        return result
...
class Cancellation:
    ...
    def __init__(self, cancellation_reason: CanceledReason, who_canceled: Role) -> None:
        self.cancellation_reason = cancellation_reason
        self.who_canceled = who_canceled

    @staticmethod
    def from_dict(obj: Any) -> 'Cancellation':
        assert isinstance(obj, dict)
        cancellation_reason = CanceledReason(obj.get("cancellation_reason"))
        who_canceled = Role(obj.get("who_canceled"))
        return Cancellation(cancellation_reason, who_canceled)

    def to_dict(self) -> dict:
        result: dict = {}
        result["cancellation_reason"] = to_enum(CanceledReason, self.cancellation_reason)
        result["who_canceled"] = to_enum(Role, self.who_canceled)
        return result
...
class Timeslot:
    ...
    def __init__(self, end_before: str, green_energy_support: Optional[bool], max_power: Optional[float], min_power: Optional[float], start_from: str) -> None:
        self.end_before = end_before
        self.green_energy_support = green_energy_support
    ...
    def from_dict(obj: Any) -> 'Timeslot':
        assert isinstance(obj, dict)
        end_before = from_str(obj.get("end_before"))
        green_energy_support = from_union([from_none, from_bool], obj.get("green_energy_support"))
        max_power = from_union([from_none, from_float], obj.get("max_power"))
        min_power = from_union([from_none, from_float], obj.get("min_power"))
        start_from = from_str(obj.get("start_from"))
        return Timeslot(end_before, green_energy_support, max_power, min_power, start_from)

    def to_dict(self) -> dict:
        result: dict = {}
        result["end_before"] = from_str(self.end_before)
        if self.green_energy_support is not None:
            result["green_energy_support"] = from_union([from_none, from_bool], self.green_energy_support)
        ...
        result["start_from"] = from_str(self.start_from)
        return result
...
class BookingToken:
    ...
    def from_dict(obj: Any) -> 'BookingToken':
        ...
        type = TokenType(obj.get("type"))
        uid = from_str(obj.get("uid"))
        return BookingToken(contract_id, country_code, party_id, type, uid)
...
class BookingRequest:
    ...
    def from_dict(obj: Any) -> 'BookingRequest':
        assert isinstance(obj, dict)
        authorization_reference = from_str(obj.get("authorization_reference"))
        bookable_parking_option = from_union([from_none, BookableParkingOptions.from_dict], obj.get("bookable_parking_option"))
        canceled = from_union([from_none, Cancellation.from_dict], obj.get("canceled"))
        connector_id = from_union([from_none, from_str], obj.get("connector_id"))
        country_code = from_str(obj.get("country_code"))
        evse_uid = from_union([from_none, from_str], obj.get("evse_uid"))
        location_id = from_str(obj.get("location_id"))
        party_id = from_str(obj.get("party_id"))
        period = Timeslot.from_dict(obj.get("period"))
        power_required = from_union([from_none, from_int], obj.get("power_required"))
        request_id = from_str(obj.get("request_id"))
        tokens = from_union([from_none, lambda x: from_list(BookingToken.from_dict, x)], obj.get("tokens"))
        return BookingRequest(authorization_reference, bookable_parking_option, canceled, connector_id, country_code, evse_uid, location_id, party_id, period, power_required, request_id, tokens)

    def to_dict(self) -> dict:
        result: dict = {}
        result["authorization_reference"] = from_str(self.authorization_reference)
        if self.bookable_parking_option is not None:
            result["bookable_parking_option"] = from_union([from_none, lambda x: to_class(BookableParkingOptions, x)], self.bookable_parking_option)
        if self.canceled is not None:
            result["canceled"] = from_union([from_none, lambda x: to_class(Cancellation, x)], self.canceled)
        ...
        result["location_id"] = from_str(self.location_id)
        result["party_id"] = from_str(self.party_id)
        result["period"] = to_class(Timeslot, self.period)
        if self.power_required is not None:
            result["power_required"] = from_union([from_none, from_int], self.power_required)
        result["request_id"] = from_str(self.request_id)
        if self.tokens is not None:
            result["tokens"] = from_union([from_none, lambda x: from_list(lambda x: to_class(BookingToken, x), x)], self.tokens)
        return result


class ReservationRequestStatus(Enum):
    ACCEPTED = "ACCEPTED"
    DECLINED = "DECLINED"
    FAILED = "FAILED"
    PENDING = "PENDING"
...
class BookingRequestStatus:
    ...
    def __init__(self, booking_request: BookingRequest, request_received: str, request_status: ReservationRequestStatus) -> None:
    ...
    def from_dict(obj: Any) -> 'BookingRequestStatus':
        assert isinstance(obj, dict)
        booking_request = BookingRequest.from_dict(obj.get("booking_request"))
        request_received = from_str(obj.get("request_received"))
        request_status = ReservationRequestStatus(obj.get("request_status"))
        return BookingRequestStatus(booking_request, request_received, request_status)

    def to_dict(self) -> dict:
        result: dict = {}
        result["booking_request"] = to_class(BookingRequest, self.booking_request)
        result["request_received"] = from_str(self.request_received)
        result["request_status"] = to_enum(ReservationRequestStatus, self.request_status)
        return result
...
class BookingTerms:
    ...
    def __init__(self, booking_terms: Optional[str], cancel_until_minutes: float, change_not_allowed: Optional[bool], change_until_minutes: float, early_start_allowed: Optional[bool], early_start_time: Optional[float], late_stop_allowed: Optional[bool], late_stop_time: Optional[float], noshow_fee: Optional[bool], noshow_timeout: Optional[float], overlapping_bookings_allowed: Optional[bool], remote_auth_supported: Optional[bool], rfid_auth_required: Optional[bool], supported_access_methods: List[LocationAccess], token_groups_supported: Optional[bool]) -> None:
        self.booking_terms = booking_terms
        self.cancel_until_minutes = cancel_until_minutes
        self.change_not_allowed = change_not_allowed
        self.change_until_minutes = change_until_minutes
        self.early_start_allowed = early_start_allowed
        self.early_start_time = early_start_time
        self.late_stop_allowed = late_stop_allowed
        self.late_stop_time = late_stop_time
        self.noshow_fee = noshow_fee
        self.noshow_timeout = noshow_timeout
        self.overlapping_bookings_allowed = overlapping_bookings_allowed
        self.remote_auth_supported = remote_auth_supported
        self.rfid_auth_required = rfid_auth_required
        self.supported_access_methods = supported_access_methods
        self.token_groups_supported = token_groups_supported

    @staticmethod
    def from_dict(obj: Any) -> 'BookingTerms':
        assert isinstance(obj, dict)
        booking_terms = from_union([from_none, from_str], obj.get("booking_terms"))
        cancel_until_minutes = from_float(obj.get("cancel_until_minutes"))
        change_not_allowed = from_union([from_none, from_bool], obj.get("change_not_allowed"))
        change_until_minutes = from_float(obj.get("change_until_minutes"))
        early_start_allowed = from_union([from_none, from_bool], obj.get("early_start_allowed"))
        early_start_time = from_union([from_none, from_float], obj.get("early_start_time"))
        late_stop_allowed = from_union([from_none, from_bool], obj.get("late_stop_allowed"))
        late_stop_time = from_union([from_none, from_float], obj.get("late_stop_time"))
        noshow_fee = from_union([from_none, from_bool], obj.get("noshow_fee"))
        noshow_timeout = from_union([from_none, from_float], obj.get("noshow_timeout"))
        overlapping_bookings_allowed = from_union([from_none, from_bool], obj.get("overlapping_bookings_allowed"))
        remote_auth_supported = from_union([from_none, from_bool], obj.get("remote_auth_supported"))
        rfid_auth_required = from_union([from_none, from_bool], obj.get("RFID_auth_required"))
        supported_access_methods = from_list(LocationAccess, obj.get("supported_access_methods"))
        token_groups_supported = from_union([from_none, from_bool], obj.get("token_groups_supported"))
        return BookingTerms(booking_terms, cancel_until_minutes, change_not_allowed, change_until_minutes, early_start_allowed, early_start_time, late_stop_allowed, late_stop_time, noshow_fee, noshow_timeout, overlapping_bookings_allowed, remote_auth_supported, rfid_auth_required, supported_access_methods, token_groups_supported)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.booking_terms is not None:
            result["booking_terms"] = from_union([from_none, from_str], self.booking_terms)
        result["cancel_until_minutes"] = to_float(self.cancel_until_minutes)
        if self.change_not_allowed is not None:
            result["change_not_allowed"] = from_union([from_none, from_bool], self.change_not_allowed)
        result["change_until_minutes"] = to_float(self.change_until_minutes)
        if self.early_start_allowed is not None:
            result["early_start_allowed"] = from_union([from_none, from_bool], self.early_start_allowed)
        if self.early_start_time is not None:
            result["early_start_time"] = from_union([from_none, to_float], self.early_start_time)
        if self.late_stop_allowed is not None:
            result["late_stop_allowed"] = from_union([from_none, from_bool], self.late_stop_allowed)
        if self.late_stop_time is not None:
            result["late_stop_time"] = from_union([from_none, to_float], self.late_stop_time)
        if self.noshow_fee is not None:
            result["noshow_fee"] = from_union([from_none, from_bool], self.noshow_fee)
        if self.noshow_timeout is not None:
            result["noshow_timeout"] = from_union([from_none, to_float], self.noshow_timeout)
        if self.overlapping_bookings_allowed is not None:
            result["overlapping_bookings_allowed"] = from_union([from_none, from_bool], self.overlapping_bookings_allowed)
        if self.remote_auth_supported is not None:
            result["remote_auth_supported"] = from_union([from_none, from_bool], self.remote_auth_supported)
        if self.rfid_auth_required is not None:
            result["RFID_auth_required"] = from_union([from_none, from_bool], self.rfid_auth_required)
        result["supported_access_methods"] = from_list(lambda x: to_enum(LocationAccess, x), self.supported_access_methods)
        if self.token_groups_supported is not None:
            result["token_groups_supported"] = from_union([from_none, from_bool], self.token_groups_supported)
        return result
...
class Booking:
    ...
    def from_dict(obj: Any) -> 'Booking':
        assert isinstance(obj, dict)
        access_methods = from_union([from_none, lambda x: from_list(AccessMethod.from_dict, x)], obj.get("access_methods"))
        authorization_reference = from_str(obj.get("authorization_reference"))
        bookable_parking_option = from_union([from_none, BookableParkingOptions.from_dict], obj.get("bookable_parking_option"))
        booking_requests = from_list(BookingRequestStatus.from_dict, obj.get("booking_requests"))
        booking_terms = BookingTerms.from_dict(obj.get("booking_terms"))
        booking_tokens = from_union([from_none, lambda x: from_list(BookingToken.from_dict, x)], obj.get("booking_tokens"))
        canceled = from_union([from_none, Cancellation.from_dict], obj.get("canceled"))
        connector_id = from_union([from_none, from_str], obj.get("connector_id"))
        country_code = from_str(obj.get("country_code"))
        evse_uid = from_union([from_none, from_str], obj.get("evse_uid"))
        ...
        last_updated = from_str(obj.get("last_updated"))
        location_id = from_str(obj.get("location_id"))
        parking_id = from_union([from_none, from_str], obj.get("parking_id"))
        party_id = from_str(obj.get("party_id"))
        period = Timeslot.from_dict(obj.get("period"))
        request_id = from_str(obj.get("request_id"))
        reservation_status = ReservationStatus(obj.get("reservation_status"))
        tariff_id = from_union([from_none, lambda x: from_list(from_str, x)], obj.get("tariff_id"))
        return Booking(access_methods, authorization_reference, bookable_parking_option, booking_requests, booking_terms, booking_tokens, canceled, connector_id, country_code, evse_uid, id, last_updated, location_id, parking_id, party_id, period, request_id, reservation_status, tariff_id)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.access_methods is not None:
            result["access_methods"] = from_union([from_none, lambda x: from_list(lambda x: to_class(AccessMethod, x), x)], self.access_methods)
        result["authorization_reference"] = from_str(self.authorization_reference)
        if self.bookable_parking_option is not None:
            result["bookable_parking_option"] = from_union([from_none, lambda x: to_class(BookableParkingOptions, x)], self.bookable_parking_option)
        result["booking_requests"] = from_list(lambda x: to_class(BookingRequestStatus, x), self.booking_requests)
        result["booking_terms"] = to_class(BookingTerms, self.booking_terms)
        if self.booking_tokens is not None:
            result["booking_tokens"] = from_union([from_none, lambda x: from_list(lambda x: to_class(BookingToken, x), x)], self.booking_tokens)
        if self.canceled is not None:
            result["canceled"] = from_union([from_none, lambda x: to_class(Cancellation, x)], self.canceled)
        if self.connector_id is not None:
            result["connector_id"] = from_union([from_none, from_str], self.connector_id)
        ...
        if self.parking_id is not None:
            result["parking_id"] = from_union([from_none, from_str], self.parking_id)
        result["party_id"] = from_str(self.party_id)
        result["period"] = to_class(Timeslot, self.period)
        result["request_id"] = from_str(self.request_id)
        result["reservation_status"] = to_enum(ReservationStatus, self.reservation_status)
        if self.tariff_id is not None:
            result["tariff_id"] = from_union([from_none, lambda x: from_list(from_str, x)], self.tariff_id)
        return result
...
class Bookable:
    ...
    def __init__(self, ad_hoc: Optional[float], reservation_required: bool) -> None:
        self.ad_hoc = ad_hoc
    ...
    def from_dict(obj: Any) -> 'Bookable':
        assert isinstance(obj, dict)
        ad_hoc = from_union([from_none, from_float], obj.get("ad_hoc"))
        reservation_required = from_bool(obj.get("reservation_required"))
        return Bookable(ad_hoc, reservation_required)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.ad_hoc is not None:
            result["ad_hoc"] = from_union([from_none, to_float], self.ad_hoc)
        result["reservation_required"] = from_bool(self.reservation_required)
        return result
...
class Calendar:
    ...
    def __init__(self, available_timeslots: List[Timeslot], begin_from: str, end_before: str, id: str, last_updated: str, step_size: Optional[int]) -> None:
    ...
    def from_dict(obj: Any) -> 'Calendar':
        assert isinstance(obj, dict)
        available_timeslots = from_list(Timeslot.from_dict, obj.get("available_timeslots"))
        begin_from = from_str(obj.get("begin_from"))
        end_before = from_str(obj.get("end_before"))
        id = from_str(obj.get("id"))
        last_updated = from_str(obj.get("last_updated"))
        step_size = from_union([from_none, from_int], obj.get("step_size"))
        return Calendar(available_timeslots, begin_from, end_before, id, last_updated, step_size)

    def to_dict(self) -> dict:
        result: dict = {}
        result["available_timeslots"] = from_list(lambda x: to_class(Timeslot, x), self.available_timeslots)
        result["begin_from"] = from_str(self.begin_from)
        result["end_before"] = from_str(self.end_before)
        result["id"] = from_str(self.id)
        result["last_updated"] = from_str(self.last_updated)
        if self.step_size is not None:
            result["step_size"] = from_union([from_none, from_int], self.step_size)
        return result
...
class BookingLocation:
    ...
    def from_dict(obj: Any) -> 'BookingLocation':
        assert isinstance(obj, dict)
        bookable = from_union([from_none, Bookable.from_dict], obj.get("bookable"))
        bookable_parking_options = from_union([from_none, lambda x: from_list(BookableParkingOptions.from_dict, x)], obj.get("bookable_parking_options"))
        booking_terms = from_union([from_none, lambda x: from_list(BookingTerms.from_dict, x)], obj.get("booking_terms"))
        calendars = from_union([from_none, lambda x: from_list(Calendar.from_dict, x)], obj.get("calendars"))
        connector_id = from_union([from_none, from_str], obj.get("connector_id"))
        country_code = from_str(obj.get("country_code"))
        evse_uid = from_union([from_none, from_str], obj.get("evse_uid"))
        id = from_str(obj.get("id"))
        ...
        party_id = from_str(obj.get("party_id"))
        tariff_id = from_union([from_none, lambda x: from_list(from_str, x)], obj.get("tariff_id"))
        return BookingLocation(bookable, bookable_parking_options, booking_terms, calendars, connector_id, country_code, evse_uid, id, last_updated, location_id, party_id, tariff_id)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.bookable is not None:
            result["bookable"] = from_union([from_none, lambda x: to_class(Bookable, x)], self.bookable)
        if self.bookable_parking_options is not None:
            result["bookable_parking_options"] = from_union([from_none, lambda x: from_list(lambda x: to_class(BookableParkingOptions, x), x)], self.bookable_parking_options)
        if self.booking_terms is not None:
            result["booking_terms"] = from_union([from_none, lambda x: from_list(lambda x: to_class(BookingTerms, x), x)], self.booking_terms)
        if self.calendars is not None:
            result["calendars"] = from_union([from_none, lambda x: from_list(lambda x: to_class(Calendar, x), x)], self.calendars)
        if self.connector_id is not None:
            result["connector_id"] = from_union([from_none, from_str], self.connector_id)
        result["country_code"] = from_str(self.country_code)
        if self.evse_uid is not None:
...
class CdrDimensionType(Enum):
    ...
    RESERVATION_OVERTIME = "RESERVATION_OVERTIME"
...
class ReservationRestrictionType(Enum):
    ...
    RESERVATION_CANCELLATION_FEES = "RESERVATION_CANCELLATION_FEES"
    RESERVATION_EXPIRES = "RESERVATION_EXPIRES"
    RESERVATION_OVERTIME = "RESERVATION_OVERTIME"
...
class PriceLimit:
    ...
    def __init__(self, after_taxes: Optional[float], before_taxes: float) -> None:
        self.after_taxes = after_taxes
        self.before_taxes = before_taxes

    @staticmethod
    def from_dict(obj: Any) -> 'PriceLimit':
        assert isinstance(obj, dict)
        after_taxes = from_union([from_none, from_float], obj.get("after_taxes"))
        before_taxes = from_float(obj.get("before_taxes"))
        return PriceLimit(after_taxes, before_taxes)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.after_taxes is not None:
            result["after_taxes"] = from_union([from_none, to_float], self.after_taxes)
        result["before_taxes"] = to_float(self.before_taxes)
        return result
...
class Tariff:
    ...
    def from_dict(obj: Any) -> 'Tariff':
        ...
        id = from_str(obj.get("id"))
        last_updated = from_str(obj.get("last_updated"))
        max_price = from_union([from_none, PriceLimit.from_dict], obj.get("max_price"))
        min_price = from_union([from_none, PriceLimit.from_dict], obj.get("min_price"))
        party_id = from_str(obj.get("party_id"))
        start_date_time = from_union([from_none, from_str], obj.get("start_date_time"))
        ...
        tax_included = TaxIncluded(obj.get("tax_included"))
        type = from_union([from_none, TariffType], obj.get("type"))
        return Tariff(country_code, currency, elements, end_date_time, energy_mix, id, last_updated, max_price, min_price, party_id, start_date_time, tariff_alt_text, tariff_alt_url, tax_included, type)
    ...
    def to_dict(self) -> dict:
        ...
        if self.max_price is not None:
            result["max_price"] = from_union([from_none, lambda x: to_class(PriceLimit, x)], self.max_price)
        if self.min_price is not None:
            result["min_price"] = from_union([from_none, lambda x: to_class(PriceLimit, x)], self.min_price)
        result["party_id"] = from_str(self.party_id)
        if self.start_date_time is not None:
            result["start_date_time"] = from_union([from_none, from_str], self.start_date_time)
        ...
        result["tax_included"] = to_enum(TaxIncluded, self.tax_included)
...
class TaxAmount:
    ...
    def __init__(self, account_number: Optional[str], amount: float, name: str, percentage: Optional[float]) -> None:
    ...
    def from_dict(obj: Any) -> 'TaxAmount':
        assert isinstance(obj, dict)
        account_number = from_union([from_none, from_str], obj.get("account_number"))
        amount = from_float(obj.get("amount"))
        name = from_str(obj.get("name"))
        percentage = from_union([from_none, from_float], obj.get("percentage"))
        return TaxAmount(account_number, amount, name, percentage)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.account_number is not None:
            result["account_number"] = from_union([from_none, from_str], self.account_number)
        result["amount"] = to_float(self.amount)
        result["name"] = from_str(self.name)
        if self.percentage is not None:
            result["percentage"] = from_union([from_none, to_float], self.percentage)
        return result
...
class Price:
    ...
    def __init__(self, before_taxes: float, taxes: Optional[List[TaxAmount]]) -> None:
        self.before_taxes = before_taxes
        self.taxes = taxes
    ...
    def from_dict(obj: Any) -> 'Price':
        assert isinstance(obj, dict)
        before_taxes = from_float(obj.get("before_taxes"))
        taxes = from_union([from_none, lambda x: from_list(TaxAmount.from_dict, x)], obj.get("taxes"))
        return Price(before_taxes, taxes)

    def to_dict(self) -> dict:
        result: dict = {}
        result["before_taxes"] = to_float(self.before_taxes)
        if self.taxes is not None:
            result["taxes"] = from_union([from_none, lambda x: from_list(lambda x: to_class(TaxAmount, x), x)], self.taxes)
        return result
...
class Cdr:
    ...
    def from_dict(obj: Any) -> 'Cdr':
        ...
        authorization_reference = from_union([from_none, from_str], obj.get("authorization_reference"))
        booking_id = from_union([from_none, from_str], obj.get("booking_id"))
    ...
    def to_dict(self) -> dict:
        ...
        if self.booking_id is not None:
            result["booking_id"] = from_union([from_none, from_str], self.booking_id)
...
class ConnectorCapability(Enum):
    ISO_15118_20__PLUG_AND_CHARGE = "ISO_15118_20_PLUG_AND_CHARGE"
    ISO_15118_2__PLUG_AND_CHARGE = "ISO_15118_2_PLUG_AND_CHARGE"
...
class Connector:
    ...
    def __init__(self, capabilities: Optional[List[ConnectorCapability]], format: ConnectorFormat, id: str, last_updated: str, max_amperage: int, max_electric_power: Optional[int], max_voltage: int, power_type: PowerType, standard: ConnectorType, tariff_ids: Optional[List[str]], terms_and_conditions: Optional[str]) -> None:
    ...
    def from_dict(obj: Any) -> 'Connector':
        assert isinstance(obj, dict)
        capabilities = from_union([from_none, lambda x: from_list(ConnectorCapability, x)], obj.get("capabilities"))
        format = ConnectorFormat(obj.get("format"))
        id = from_str(obj.get("id"))
        last_updated = from_str(obj.get("last_updated"))
        ...
        return Connector(capabilities, format, id, last_updated, max_amperage, max_electric_power, max_voltage, power_type, standard, tariff_ids, terms_and_conditions)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.capabilities is not None:
            result["capabilities"] = from_union([from_none, lambda x: from_list(lambda x: to_enum(ConnectorCapability, x), x)], self.capabilities)
        result["format"] = to_enum(ConnectorFormat, self.format)
        result["id"] = from_str(self.id)
        result["last_updated"] = from_str(self.last_updated)
...
class Credentials:
    ...
    def __init__(self, hub_party_id: Optional[str], roles: List[CredentialsRole], token: str, url: str) -> None:
        self.hub_party_id = hub_party_id
        self.roles = roles
        self.token = token
        self.url = url
    ...
    def from_dict(obj: Any) -> 'Credentials':
        assert isinstance(obj, dict)
        hub_party_id = from_union([from_none, from_str], obj.get("hub_party_id"))
        roles = from_list(CredentialsRole.from_dict, obj.get("roles"))
        token = from_str(obj.get("token"))
        url = from_str(obj.get("url"))
        return Credentials(hub_party_id, roles, token, url)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.hub_party_id is not None:
            result["hub_party_id"] = from_union([from_none, from_str], self.hub_party_id)
...
class EvseParking:
    ...
    def __init__(self, evse_position: Optional[EvsePosition], parking_id: str) -> None:
        self.evse_position = evse_position
        self.parking_id = parking_id
    ...
    def from_dict(obj: Any) -> 'EvseParking':
        assert isinstance(obj, dict)
        evse_position = from_union([from_none, EvsePosition], obj.get("evse_position"))
        parking_id = from_str(obj.get("parking_id"))
        return EvseParking(evse_position, parking_id)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.evse_position is not None:
            result["evse_position"] = from_union([from_none, lambda x: to_enum(EvsePosition, x)], self.evse_position)
        result["parking_id"] = from_str(self.parking_id)
        return result
...
class Evse:
    ...
    def from_dict(obj: Any) -> 'Evse':
        assert isinstance(obj, dict)
        accepted_service_providers = from_union([from_none, lambda x: from_list(from_str, x)], obj.get("accepted_service_providers"))
        ...
        last_updated = from_str(obj.get("last_updated"))
        parking = from_union([from_none, lambda x: from_list(EvseParking.from_dict, x)], obj.get("parking"))
        ...
        uid = from_str(obj.get("uid"))
        return Evse(accepted_service_providers, capabilities, connectors, coordinates, directions, evse_id, floor_level, images, last_updated, parking, parking_restrictions, physical_reference, status, status_schedule, uid)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.accepted_service_providers is not None:
            result["accepted_service_providers"] = from_union([from_none, lambda x: from_list(from_str, x)], self.accepted_service_providers)
        if self.capabilities is not None:
        ...
        if self.parking is not None:
            result["parking"] = from_union([from_none, lambda x: from_list(lambda x: to_class(EvseParking, x), x)], self.parking)
...
class Parking:
    ...
    def __init__(self, apds_reference: Optional[str], dangerous_goods_allowed: Optional[bool], direction: Optional[ParkingDirection], drive_through: Optional[bool], id: str, images: Optional[List[Image]], lighting: Optional[bool], max_vehicle_height: Optional[float], max_vehicle_length: Optional[float], max_vehicle_weight: Optional[float], max_vehicle_width: Optional[float], parking_space_length: Optional[float], parking_space_width: Optional[float], physical_reference: Optional[str], refrigeration_outlet: Optional[bool], reservation_required: bool, restricted_to_type: bool, roofed: Optional[bool], standards: Optional[List[str]], time_limit: Optional[float], vehicle_types: List[VehicleType]) -> None:
        self.apds_reference = apds_reference
        self.dangerous_goods_allowed = dangerous_goods_allowed
    ...
    def from_dict(obj: Any) -> 'Parking':
        assert isinstance(obj, dict)
        apds_reference = from_union([from_none, from_str], obj.get("apds_reference"))
        dangerous_goods_allowed = from_union([from_none, from_bool], obj.get("dangerous_goods_allowed"))
        direction = from_union([from_none, ParkingDirection], obj.get("direction"))
        drive_through = from_union([from_none, from_bool], obj.get("drive_through"))
        id = from_str(obj.get("id"))
        images = from_union([from_none, lambda x: from_list(Image.from_dict, x)], obj.get("images"))
        lighting = from_union([from_none, from_bool], obj.get("lighting"))
        max_vehicle_height = from_union([from_none, from_float], obj.get("max_vehicle_height"))
        max_vehicle_length = from_union([from_none, from_float], obj.get("max_vehicle_length"))
        max_vehicle_weight = from_union([from_none, from_float], obj.get("max_vehicle_weight"))
        max_vehicle_width = from_union([from_none, from_float], obj.get("max_vehicle_width"))
        ...
        reservation_required = from_bool(obj.get("reservation_required"))
        restricted_to_type = from_bool(obj.get("restricted_to_type"))
        roofed = from_union([from_none, from_bool], obj.get("roofed"))
        standards = from_union([from_none, lambda x: from_list(from_str, x)], obj.get("standards"))
        time_limit = from_union([from_none, from_float], obj.get("time_limit"))
        vehicle_types = from_list(VehicleType, obj.get("vehicle_types"))
    ...
    def to_dict(self) -> dict:
        result: dict = {}
        if self.apds_reference is not None:
            result["apds_reference"] = from_union([from_none, from_str], self.apds_reference)
        if self.dangerous_goods_allowed is not None:
            result["dangerous_goods_allowed"] = from_union([from_none, from_bool], self.dangerous_goods_allowed)
        if self.direction is not None:
            result["direction"] = from_union([from_none, lambda x: to_enum(ParkingDirection, x)], self.direction)
        if self.drive_through is not None:
            result["drive_through"] = from_union([from_none, from_bool], self.drive_through)
        result["id"] = from_str(self.id)
        if self.images is not None:
        ...
        if self.lighting is not None:
            result["lighting"] = from_union([from_none, from_bool], self.lighting)
        if self.max_vehicle_height is not None:
            result["max_vehicle_height"] = from_union([from_none, to_float], self.max_vehicle_height)
        if self.max_vehicle_length is not None:
            result["max_vehicle_length"] = from_union([from_none, to_float], self.max_vehicle_length)
        ...
        result["reservation_required"] = from_bool(self.reservation_required)
        result["restricted_to_type"] = from_bool(self.restricted_to_type)
        if self.roofed is not None:
            result["roofed"] = from_union([from_none, from_bool], self.roofed)
        if self.standards is not None:
            result["standards"] = from_union([from_none, lambda x: from_list(from_str, x)], self.standards)
        if self.time_limit is not None:
            result["time_limit"] = from_union([from_none, to_float], self.time_limit)
        result["vehicle_types"] = from_list(lambda x: to_enum(VehicleType, x), self.vehicle_types)
        return result
...
class Location:
    ...
    def from_dict(obj: Any) -> 'Location':
        ...
        help_phone = from_union([from_none, from_str], obj.get("help_phone"))
        id = from_str(obj.get("id"))
        images = from_union([from_none, lambda x: from_list(Image.from_dict, x)], obj.get("images"))
        last_updated = from_str(obj.get("last_updated"))
        name = from_union([from_none, from_str], obj.get("name"))
        ...
        parking_places = from_union([from_none, lambda x: from_list(Parking.from_dict, x)], obj.get("parking_places"))
    ...
    def to_dict(self) -> dict:
        ...
        if self.help_phone is not None:
            result["help_phone"] = from_union([from_none, from_str], self.help_phone)
        result["id"] = from_str(self.id)
        if self.images is not None:
            result["images"] = from_union([from_none, lambda x: from_list(lambda x: to_class(Image, x), x)], self.images)
        result["last_updated"] = from_str(self.last_updated)
        ...
        if self.parking_places is not None:
            result["parking_places"] = from_union([from_none, lambda x: from_list(lambda x: to_class(Parking, x), x)], self.parking_places)
...
class V230Bookings:
    ...
    def from_dict(obj: Any) -> 'V230Bookings':
        ...
        booking = from_union([Booking.from_dict, from_none], obj.get("booking"))
        booking_location = from_union([BookingLocation.from_dict, from_none], obj.get("booking_location"))
        booking_request = from_union([BookingRequest.from_dict, from_none], obj.get("booking_request"))
        calendar = from_union([Calendar.from_dict, from_none], obj.get("calendar"))
    ...
    def to_dict(self) -> dict:
        ...
        if self.booking is not None:
            result["booking"] = from_union([lambda x: to_class(Booking, x), from_none], self.booking)
        if self.booking_location is not None:
            result["booking_location"] = from_union([lambda x: to_class(BookingLocation, x), from_none], self.booking_location)
        if self.booking_request is not None:
            result["booking_request"] = from_union([lambda x: to_class(BookingRequest, x), from_none], self.booking_request)
        if self.calendar is not None:
            result["calendar"] = from_union([lambda x: to_class(Calendar, x), from_none], self.calendar)
...
def v230_bookings_from_dict(s: Any) -> V230Bookings:
    return V230Bookings.from_dict(s)


def v230_bookings_to_dict(x: V230Bookings) -> Any:
    return to_class(V230Bookings, x)
