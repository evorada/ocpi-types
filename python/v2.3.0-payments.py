...
class Tariff:
    ...
    def __init__(self, country_code: str, currency: str, elements: List[TariffElement], end_date_time: Optional[str], energy_mix: Optional[EnergyMix], id: str, last_updated: str, max_price: Optional[PriceLimit], min_price: Optional[PriceLimit], party_id: str, preauthorize_amount: Optional[float], start_date_time: Optional[str], tariff_alt_text: Optional[List[DisplayText]], tariff_alt_url: Optional[str], tax_included: TaxIncluded, type: Optional[TariffType]) -> None:
        ...
        self.party_id = party_id
        self.preauthorize_amount = preauthorize_amount
        self.start_date_time = start_date_time
    ...
    def from_dict(obj: Any) -> 'Tariff':
        ...
        party_id = from_str(obj.get("party_id"))
        preauthorize_amount = from_union([from_none, from_float], obj.get("preauthorize_amount"))
        start_date_time = from_union([from_none, from_str], obj.get("start_date_time"))
        ...
        return Tariff(country_code, currency, elements, end_date_time, energy_mix, id, last_updated, max_price, min_price, party_id, preauthorize_amount, start_date_time, tariff_alt_text, tariff_alt_url, tax_included, type)
    ...
    def to_dict(self) -> dict:
        ...
        result["party_id"] = from_str(self.party_id)
        if self.preauthorize_amount is not None:
            result["preauthorize_amount"] = from_union([from_none, to_float], self.preauthorize_amount)
        if self.start_date_time is not None:
            result["start_date_time"] = from_union([from_none, from_str], self.start_date_time)
...
class FinancialAdviceConfirmation:
    ...
    def __init__(self, authorization_reference: str, capture_status_code: CaptureStatusCode, capture_status_message: Optional[str], currency: str, eft_data: List[str], id: str, last_updated: str, total_costs: Price) -> None:
        self.authorization_reference = authorization_reference
        self.capture_status_code = capture_status_code
        self.capture_status_message = capture_status_message
        self.currency = currency
        self.eft_data = eft_data
        self.id = id
        self.last_updated = last_updated
    ...
    def from_dict(obj: Any) -> 'FinancialAdviceConfirmation':
        ...
        capture_status_code = CaptureStatusCode(obj.get("capture_status_code"))
        capture_status_message = from_union([from_none, from_str], obj.get("capture_status_message"))
        currency = from_str(obj.get("currency"))
        eft_data = from_list(from_str, obj.get("eft_data"))
        id = from_str(obj.get("id"))
        last_updated = from_str(obj.get("last_updated"))
        total_costs = Price.from_dict(obj.get("total_costs"))
        return FinancialAdviceConfirmation(authorization_reference, capture_status_code, capture_status_message, currency, eft_data, id, last_updated, total_costs)

    def to_dict(self) -> dict:
        result: dict = {}
        result["authorization_reference"] = from_str(self.authorization_reference)
        result["capture_status_code"] = to_enum(CaptureStatusCode, self.capture_status_code)
        if self.capture_status_message is not None:
            result["capture_status_message"] = from_union([from_none, from_str], self.capture_status_message)
        result["currency"] = from_str(self.currency)
        result["eft_data"] = from_list(from_str, self.eft_data)
        result["id"] = from_str(self.id)
        result["last_updated"] = from_str(self.last_updated)
        result["total_costs"] = to_class(Price, self.total_costs)
        return result
...
class Terminal:
    ...
    def __init__(self, address: Optional[str], city: Optional[str], coordinates: Optional[GeoLocation], country: Optional[str], country_code: Optional[str], customer_reference: Optional[str], evse_uids: Optional[List[str]], invoice_base_url: Optional[str], invoice_creator: Optional[InvoiceCreator], last_updated: str, location_ids: Optional[List[str]], party_id: Optional[str], postal_code: Optional[str], reference: Optional[str], state: Optional[str], terminal_id: str) -> None:
        ...
        self.evse_uids = evse_uids
        self.invoice_base_url = invoice_base_url
        self.invoice_creator = invoice_creator
        self.last_updated = last_updated
    ...
    def from_dict(obj: Any) -> 'Terminal':
        ...
        country_code = from_union([from_none, from_str], obj.get("country_code"))
        customer_reference = from_union([from_none, from_str], obj.get("customer_reference"))
        evse_uids = from_union([from_none, lambda x: from_list(from_str, x)], obj.get("evse_uids"))
        invoice_base_url = from_union([from_none, from_str], obj.get("invoice_base_url"))
        invoice_creator = from_union([from_none, InvoiceCreator], obj.get("invoice_creator"))
        last_updated = from_str(obj.get("last_updated"))
        location_ids = from_union([from_none, lambda x: from_list(from_str, x)], obj.get("location_ids"))
        party_id = from_union([from_none, from_str], obj.get("party_id"))
        postal_code = from_union([from_none, from_str], obj.get("postal_code"))
        reference = from_union([from_none, from_str], obj.get("reference"))
        state = from_union([from_none, from_str], obj.get("state"))
        terminal_id = from_str(obj.get("terminal_id"))
        return Terminal(address, city, coordinates, country, country_code, customer_reference, evse_uids, invoice_base_url, invoice_creator, last_updated, location_ids, party_id, postal_code, reference, state, terminal_id)
    ...
    def to_dict(self) -> dict:
        ...
        if self.country_code is not None:
            result["country_code"] = from_union([from_none, from_str], self.country_code)
        if self.customer_reference is not None:
            result["customer_reference"] = from_union([from_none, from_str], self.customer_reference)
        if self.evse_uids is not None:
            result["evse_uids"] = from_union([from_none, lambda x: from_list(from_str, x)], self.evse_uids)
        if self.invoice_base_url is not None:
            result["invoice_base_url"] = from_union([from_none, from_str], self.invoice_base_url)
        if self.invoice_creator is not None:
            result["invoice_creator"] = from_union([from_none, lambda x: to_enum(InvoiceCreator, x)], self.invoice_creator)
        result["last_updated"] = from_str(self.last_updated)
        if self.location_ids is not None:
            result["location_ids"] = from_union([from_none, lambda x: from_list(from_str, x)], self.location_ids)
        if self.party_id is not None:
            result["party_id"] = from_union([from_none, from_str], self.party_id)
        if self.postal_code is not None:
            result["postal_code"] = from_union([from_none, from_str], self.postal_code)
        if self.reference is not None:
            result["reference"] = from_union([from_none, from_str], self.reference)
        if self.state is not None:
            result["state"] = from_union([from_none, from_str], self.state)
        result["terminal_id"] = from_str(self.terminal_id)
        return result
...
class V230Payments:
    ...
    def __init__(self, active_charging_profile: Optional[ActiveChargingProfile], active_charging_profile_result: Optional[ActiveChargingProfileResult], authorization_info: Optional[AuthorizationInfo], cancel_reservation: Optional[CancelReservation], cdr: Optional[Cdr], charging_preferences: Optional[ChargingPreferences], charging_profile: Optional[ChargingProfile], charging_profile_response: Optional[ChargingProfileResponse], charging_profile_result: Optional[ChargingProfileResult], clear_profile_result: Optional[ClearProfileResult], command_response: Optional[CommandResponse], command_result: Optional[CommandResult], connector: Optional[Connector], credentials: Optional[Credentials], endpoint: Optional[Endpoint], evse: Optional[Evse], financial_advice_confirmation: Optional[FinancialAdviceConfirmation], hub_client_info: Optional[HubClientInfo], location: Optional[Location], location_references: Optional[LocationReferences], reserve_now: Optional[ReserveNow], session: Optional[Session], set_charging_profile: Optional[SetChargingProfile], start_session: Optional[StartSession], stop_session: Optional[StopSession], tariff: Optional[Tariff], terminal: Optional[Terminal], token: Optional[Token], unlock_connector: Optional[UnlockConnector], version: Optional[Version], version_details: Optional[VersionDetails]) -> None:
        ...
        self.evse = evse
        self.financial_advice_confirmation = financial_advice_confirmation
    ...
    def from_dict(obj: Any) -> 'V230Payments':
        ...
        financial_advice_confirmation = from_union([FinancialAdviceConfirmation.from_dict, from_none], obj.get("financial_advice_confirmation"))
        ...
        terminal = from_union([Terminal.from_dict, from_none], obj.get("terminal"))
    ...
    def to_dict(self) -> dict:
        ...
        if self.financial_advice_confirmation is not None:
            result["financial_advice_confirmation"] = from_union([lambda x: to_class(FinancialAdviceConfirmation, x), from_none], self.financial_advice_confirmation)
        ...
        if self.terminal is not None:
            result["terminal"] = from_union([lambda x: to_class(Terminal, x), from_none], self.terminal)
...
def v230_payments_from_dict(s: Any) -> V230Payments:
    return V230Payments.from_dict(s)


def v230_payments_to_dict(x: V230Payments) -> Any:
    return to_class(V230Payments, x)
