...
//
//    v230Payments, err := UnmarshalV230Payments(bytes)
//    bytes, err = v230Payments.Marshal()

package v230payments

import "encoding/json"

func UnmarshalV230Payments(data []byte) (V230Payments, error) {
	var r V230Payments
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *V230Payments) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

type V230Payments struct {
	...
	FinancialAdviceConfirmation *FinancialAdviceConfirmation `json:"financial_advice_confirmation,omitempty"`
...
type Tariff struct {
	...
	PartyID            string          `json:"party_id"`
	PreauthorizeAmount *float64        `json:"preauthorize_amount"`
	StartDateTime      *string         `json:"start_date_time"`
...
type FinancialAdviceConfirmation struct {
	...
	CaptureStatusMessage   *string           `json:"capture_status_message"`
	Currency               string            `json:"currency"`
...
type Terminal struct {
	...
	InvoiceCreator    *InvoiceCreator `json:"invoice_creator"`
	LastUpdated       string          `json:"last_updated"`
...
const (
	...
	PartialSuccess          CaptureStatusCode = "PARTIAL_SUCCESS"
	Success                 CaptureStatusCode = "SUCCESS"
)
