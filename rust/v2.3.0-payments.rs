...
//
// use generated_module::v2.3.0-payments;
//
// fn main() {
//     let json = r#"{"answer": 42}"#;
//     let model: v2.3.0-payments = serde_json::from_str(&json).unwrap();
// }

use serde::{Serialize, Deserialize};

#[derive(Serialize, Deserialize)]
pub struct V230Payments {
    ...
    financial_advice_confirmation: Option<FinancialAdviceConfirmation>,
...
pub struct Tariff {
    ...
    preauthorize_amount: Option<f64>,
...
pub struct FinancialAdviceConfirmation {
    ...
    capture_status_message: Option<String>,
...
pub struct Terminal {
    ...
    invoice_base_url: Option<String>,

    invoice_creator: Option<InvoiceCreator>,
